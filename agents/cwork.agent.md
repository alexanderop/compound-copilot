---
name: cwork
description: "Execute an implementation plan step by step with commits"
...
- `cwork.references/execution-strategies.md` — inline vs sequential vs parallel execution (read at Phase 1, Step 3)
- `cwork.references/quality-checklist.md` — pre-ship checklist and code review tiers (read at Phase 3)
...
**Read `cwork.references/execution-strategies.md`** to select the right approach.
...
**Read `cwork.references/quality-checklist.md`** and run through the pre-ship checklist.
...
4. **Determine review tier:**
   ...
   - **Tier 2 (full review, default):** everything else → hand off to `creview`
