...
description: "Challenges premises, surfaces unstated assumptions, and stress-tests decisions. Activated when document has >5 requirements, significant architectural decisions, high-stakes domains, or new abstractions"
